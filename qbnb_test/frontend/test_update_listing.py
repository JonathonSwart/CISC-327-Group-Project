...
class UpdateListingPage(BaseCase):
    def test_update_listing(self, *_):
        """
        This function's purpose is to test the update listing
        page in QBNB. This is done through Seleniumbase
        and utilizing 3 blackbox testing methods. Those methods
        are...Output partition testing, Functionality testing,
        and Shotgun Testing.
        """
        ...
        # Test 1
        self.find_element(
            '/html/body/div[2]/div[2]/div/form/input[3]').send_keys("30000000")
        self.find_element('/html/body/div[2]/div[2]/div/form/button').click()
        # Failed to update
        self.assert_text("one or more inputs are incorrect")
        # Test 2
        ...
        self.find_element(
            '/html/body/div[2]/div[2]/div/form/input[1]').send_keys("this IS TEStin&")
        self.find_element('/html/body/div[2]/div[2]/div/form/button').click()
        # Failed to update
        self.assert_text("one or more inputs are incorrect")
        # Test 3
        self.find_element(
            '/html/body/div[2]/div[2]/div/form/input[2]').send_keys(" jsnfjisndngjnj#) ")
        ...
        # Test 5; R5-
        self.find_element(
            '/html/body/div[2]/div[2]/div/form/input[1]').send_keys("Final updated house")
        self.find_element('/html/body/div[2]/div[2]/div/form/input[2]').send_keys(
